...
public class TeamMemberSelectorDialogActivity extends ListActivity {

    public static final String KEY_SELECTED_ITEM_ID = "selectedItemId";
    public static final String KEY_ID_TO_EXCLUDE = "idToExclude";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idToExclude = getIntent().getStringExtra(KEY_ID_TO_EXCLUDE);
            ...
            public void done(Object o, Throwable throwable) {
                ...
                if (result.isEmpty()) {
                    ...
                    for (ParseUser userObject : result) {
                        if (!idToExclude.equals(userObject.getObjectId()))
                            dataList.add(userObject);
                    }
                    if (dataList.isEmpty())
                        setEmptyText(true);
                    adapter = new SelectorListAdapter(getApplicationContext(), dataList, requestCode);
