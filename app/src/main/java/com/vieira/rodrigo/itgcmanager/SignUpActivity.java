...
public class SignUpActivity extends Activity {
    ...
    public void attemptRegister() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            registerUserToParse(fullName, role, email, userName, password);
        }
    }
    ...
    private void registerUserToParse(String fullName, String role, String email, String userName, String password) {
        ...
        user.signUpInBackground(new SignUpCallback() {
            ...
            public void done(ParseException e) {
                ...
                if (e == null){
                    ...
                    // TODO Lead to the mains manu Activity
                }
                else {
